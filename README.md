...
- Конденсатор C2 был отодвинут от датчика HS1101 и таймера TLC555. Увеличение расстояния до источников импульсных помех позволило исключить их наводки на времязадающую цепь LM331, что позволило добиться стабильных и не плавающих значений. На фото ниже приведены осциллограммы до и после переразводки.
