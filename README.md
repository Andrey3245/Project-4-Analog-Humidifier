...
Проверка всех режимов и защиты представлена на видео по ссылке: [Rutube](https://rutube.ru/shorts/641ee87b57236966e0b463477e368397/)
...
Если бы стояла задача получить абсолютную точность временных интервалов и безупречную логику работы — микроконтроллерное решение оказалось бы проще, быстрее и предсказуемее.
