...
Чтобы не перегружать страницу множеством фотографий, видео со всеми измерениями доступно по ссылке [Rutube](URL). На видео также демонстрируется, что включение нагрузки не влияет на показания преобразователя.
