...
Выход пара организован через направляющий цилиндр, сверху на который установлен вращающийся распылитель. Воздух от вентилятора подаётся через небольшой прямоугольный воздуховод, выдувая пар наружу. Отдельной доработкой стала небольшая направляющая для воздуховода — она предотвращает попадание капель воды с распылителя по воздуховоду на вентилятор.
<img width="2243" height="2560" alt="image" src="https://github.com/user-attachments/assets/e9072671-48ef-4e25-9414-5ca41af70589" />
Печатная плата и нижняя закрывающая крышка закреплены на вплавляемых гайках. На передней панели расположены два поворотных переключателя и кнопка управления подсветкой, а также скрыто установлен красный светодиод, сигнализирующий об отсутствии воды.  
На задней панели размещены разъём питания, выключатель и датчик влажности. Датчик выведен наружу корпуса, чтобы на него не попадал пар от увлажнителя, а вентилятор не вносил помехи в измерения.
