...
Чтобы не перегружать страницу множеством фотографий, видео со всеми измерениями доступно по ссылке [Rutube](https://rutube.ru/video/4c1b55bbf8e96ef4fcbd13ee093800f4/?r=wd). На видео также демонстрируется, что включение нагрузки не влияет на показания преобразователя.
