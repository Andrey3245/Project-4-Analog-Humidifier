...
## Готовая плата
Готовая плата изготовлена классическим фоторезистивным методом, который позволил точно воспроизвести топологию. Сверху на плату нанесена паяльная маска, сформированная путём УФ-экспонирования через фотошаблон. Она защищает дорожки от окисления и случайных замыканий при пайке.
...
Для вывода пара наружу используется вентилятор, воздух от которого подаётся через прямоугольный воздуховод с небольшой направляющей, предотвращающей попадание капель воды с распылителя на вентилятор
