...
## Описание проекта
<img width="4096" height="2310" alt="IMG_0810" src="https://github.com/user-attachments/assets/16d28ef2-24f0-4b14-956d-b153af54b088" />
Большинство моих предыдущих устройств строились вокруг микроконтроллера. Это привычный и надёжный способ реализовать любую логику: все алгоритмы управления и обработки сигналов реализуются программно.

В этом проекте я решил сознательно отказаться от микроконтроллера и проверить, можно ли реализовать ту же функциональность на аналоговых и дискретных компонентах, без единой строки кода.
